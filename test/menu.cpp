...
/*questions
	...
	пункт меню 4 логика выводить файлы папки /firmware для удобства ввода пути или производльная папка ?
	...
	куда сохранять *.txt или разбирать sql, json
	спросить про паттерн для меню
*/
#include <iostream>
#include <string>
#include <map>
